...
<head>
    ...
    {{-- <link rel="canonical" href="https://2865-27-124-95-219.ngrok-free.app"> --}}
    {{-- <link rel="icon" href="https://5b54-180-254-69-237.ngrok-free.app/favicon.png" type="image/x-icon"> --}}
    <title>{{ config('app.name') }} </title>
    <meta name="description" content="{{ env('APP_DESCRIPTION', 'Laravel description') }}">
    <link rel="stylesheet" href="{{ asset('css/app.css') }}">
    {{-- <link rel="stylesheet" href="https://5b54-180-254-69-237.ngrok-free.app/css/app.css"> --}}
        ...
        <div class="mx-auto max-w-screen-xl">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {{ date('Y') }} <a
                        href="https://rajagadai.id/" class="hover:underline">{{ config('app.name') }}</a>. All Rights Reserved.
                </span>
